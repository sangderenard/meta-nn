...
set "GATE_PREGESTATION_LOSS_TARGET=0.80"
...
set "SEMANTIC_VOCAB_PREGESTATION_SAMPLES_PER_COMBO=8"
...
set "SEMANTIC_STAGE_CACHE_MAX_MB=8192"
set "PREGESTATION_STAGE_CACHE_MAX_MB=8192"
set "GESTATION_STAGE_CACHE_MAX_MB=8192"
set "SEMANTIC_STAGE_CACHE_OVERFLOW_STRATEGY=evict"
set "SEMANTIC_STAGE_CACHE_REBUILD=0"
set "SEMANTIC_GPU_PREPROCESS=1"
set "SEMANTIC_PRELOAD_WORKERS=0"
...
if not "%PREGESTATION_DEFORMATIONS_PER_CLEAN%"=="" set "SEMANTIC_STAGE_CACHE_ARG=%SEMANTIC_STAGE_CACHE_ARG% --pregestation-deformations-per-clean %PREGESTATION_DEFORMATIONS_PER_CLEAN%"
...
if "%SEMANTIC_GPU_PREPROCESS%"=="1" (
  set "SEMANTIC_STAGE_CACHE_ARG=%SEMANTIC_STAGE_CACHE_ARG% --semantic-gpu-preprocess"
) else (
  set "SEMANTIC_STAGE_CACHE_ARG=%SEMANTIC_STAGE_CACHE_ARG% --no-semantic-gpu-preprocess"
)
if not "%SEMANTIC_PRELOAD_WORKERS%"=="" set "SEMANTIC_STAGE_CACHE_ARG=%SEMANTIC_STAGE_CACHE_ARG% --semantic-preload-workers %SEMANTIC_PRELOAD_WORKERS%"
set "GD_VOCAB_ARG="
