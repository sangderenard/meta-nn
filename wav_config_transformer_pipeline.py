...
_EXTRACTED_SYMBOLS = {
    ...
    "_apply_classifier_init": "pipeline.nodes.classifier_node",
    "_run_classifier_refresh_epochs": "pipeline.nodes.classifier_node",
    "_run_fake_class_refresh_epochs": "pipeline.nodes.classifier_node",
    "_sync_gate_classifier_replica": "pipeline.nodes.classifier_node",
    "_auto_berkeley_refresh_batch_size": "pipeline.nodes.data_nodes",
    "_build_berkeley_wheel_loader": "pipeline.nodes.data_nodes",
    "_build_berkeley_payload_bank": "pipeline.nodes.data_nodes",
    "_build_berkeley_refresh_cache": "pipeline.nodes.data_nodes",
    "build_stage_loaders": "pipeline.nodes.data_nodes",
    ...
    "_normalize_extra_terms": "pipeline.nodes.vocab_node",
