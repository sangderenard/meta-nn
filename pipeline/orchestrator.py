...
def build_pipeline_graph(
    ...
    speculative_cfg = SpeculativeNetConfig(
        ...
        stage0_grad_accum_steps=int(getattr(classifier_cfg, "stage0_grad_accum_steps", -1)),
        stage1_grad_accum_steps=int(getattr(classifier_cfg, "stage1_grad_accum_steps", -1)),
        stage2_grad_accum_steps=int(getattr(classifier_cfg, "stage2_grad_accum_steps", 100)),
